        ...
        <div class="row">
          <div class="col-sm-8">
              <div class="card">
                  ...
                  <form action="{{ base_url('Usdinas/update/'.$usdinas->id_admin) }}" method="POST" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="dinas">Username</label>
                      <input value="{{ $usdinas->nama }}" name="nama" type="text" class="form-control" placeholder="Nama Dinas">
                      {{-- Validasi Field --}}
                      @if($errors->has('nama'))
                 ...
                 <!--    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input value="{{ $usdinas->email }}" name="email" type="text" class="form-control" placeholder="Nama Dinas">
                      {{-- Validasi Field --}}
                      @if($errors->has('email'))
